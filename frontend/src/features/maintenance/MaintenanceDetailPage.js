...
function renderMaintenanceReceiptHtml(data) {
  ...
  return `
    ...
    </style></head><body style="position:relative;min-height:100vh;">
    <div class="watermark-wrap" aria-hidden="true"><div class="watermark-text">${data.society?.name || "Society"}</div></div>
    <div class="header">
      ...
      <h1>${data.society?.name || "Society"}</h1>
