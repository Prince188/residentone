...
const DEFAULT_ROLE_PERMISSIONS = {
  ...
  manager: ["manage_houses", "manage_maintenance", "create_notice", "manage_amenities", "manage_bookings", "create_poll", "create_survey", "manage_complaints", "manage_visitors", "view_financials", "manage_directory", "manage_committee", "manage_collections", "collect_donations", "manage_documents", "manage_staff"],
  treasurer: ["manage_maintenance", "manage_collections", "collect_donations", "manage_documents", "view_financials", "manage_directory"],
  accountant: ["manage_maintenance", "manage_collections", "collect_donations", "manage_documents", "view_financials"],
